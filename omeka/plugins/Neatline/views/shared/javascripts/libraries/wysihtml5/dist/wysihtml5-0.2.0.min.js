...
return b[0]}function h(c){c._ranges.length=0;if("None"==c.nativeSelection.type)d(c);else{var f=c.nativeSelection.createRange();c.rangeCount=f.length;for(var h,j=g.getDocument(f.item(0)),e=0;e<c.rangeCount;++e)h=a.createRange(j),h.selectNode(f.item(e)),c._ranges.push(h);c.isCollapsed=1==c.rangeCount&&c._ranges[0].collapsed;b(c,c._ranges[c.rangeCount-1],!1)}}function i(a){this.nativeSelection=a;this._ranges=[];this.refresh()}function k(a,b){if(a.anchorNode&&g.getDocument(a.anchorNode)!==g.getDocument(b))throw new t("WRONG_DOCUMENT_ERR");
}function j(a){var b=[],c=new o(a.anchorNode,a.anchorOffset),g=new o(a.focusNode,a.focusOffset),d="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var f=0,h=a.rangeCount;f<h;++f)b[f]=n.inspect(a.getRangeAt(f));return"["+d+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+g.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var g=a.dom,l=a.util,n=a.DomRange,q=a.WrappedRange,t=a.DOMException,
...
f,d)}}};
wysihtml5.dom.parse=function(){function a(c,f){var e=c.childNodes,j=e.length,h;h=b[c.nodeType];var i=0;h=h&&h(c);if(!h)return null;for(i=0;i<j;i++)(newChild=a(e[i],f))&&h.appendChild(newChild);return f&&1>=h.childNodes.length&&h.nodeName.toLowerCase()===d&&h.innerHTML!==wysihtml5.selection.PLACEHOLDER_TEXT&&!h.attributes.length?h.firstChild:h}function c(a,b){var b=b.toLowerCase(),c;if(c="IMG"==a.nodeName)if(c="src"==b){var d;try{d=a.complete&&!a.mozMatchesSelector(":-moz-broken")}catch(f){a.complete&&"complete"===
...
/^https?:\/\//i;return function(b){return!b||!b.match(a)?null:b.replace(a,function(a){return a.toLowerCase()})}}(),alt:function(){var a=/[^ a-z0-9_\-]/gi;return function(b){return!b?"":b.replace(a,"")}}(),numbers:function(){var a=/\D/g;return function(b){return(b||"").replace(a,"")||null}}()},j={align_img:function(){var a={left:"wysiwyg-float-left",right:"wysiwyg-float-right"};return function(b){return a[(""+b).toLowerCase()]}}(),align_text:function(){var a={left:"wysiwyg-text-align-left",right:"wysiwyg-text-align-right",
