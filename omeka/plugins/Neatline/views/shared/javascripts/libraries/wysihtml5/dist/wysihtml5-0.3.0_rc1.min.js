...
var c=this.startContainer,d=this.startOffset,i=this.commonAncestorContainer,e=new q(this,!0);c!==i&&(c=l.getClosestAncestorIn(c,i,!0),d=f(c),c=d.node,d=d.offset);j(e,A);e.reset();i=a(e);e.detach();b(this,c,d,c,d);return i}}function I(b,d,j){function h(a,b){return function(c){o(this);z(c,L);z(M(c),G);c=(a?e:f)(c);(b?n:g)(this,c.node,c.offset)}}function n(a,b,c){var i=a.endContainer,e=a.endOffset;if(b!==a.startContainer||c!==a.startOffset){if(M(b)!=M(i)||1==l.comparePoints(b,c,i,e))i=b,e=c;d(a,b,c,
i,e)}}function g(a,b,c){var i=a.startContainer,e=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(M(b)!=M(i)||-1==l.comparePoints(b,c,i,e))i=b,e=c;d(a,i,e,b,c)}}b.prototype=new D;a.util.extend(b.prototype,{setStart:function(a,b){o(this);x(a,!0);w(a,b);n(this,a,b)},setEnd:function(a,b){o(this);x(a,!0);w(a,b);g(this,a,b)},setStartBefore:h(!0,!0),setStartAfter:h(!1,!0),setEndBefore:h(!0,!1),setEndAfter:h(!1,!1),collapse:function(a){v(this);a?d(this,this.startContainer,this.startOffset,this.startContainer,
...
detach:function(){j(this)},splitBoundaries:function(){v(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,i=this.endOffset,e=a===c;l.isCharacterDataNode(c)&&0<i&&i<c.length&&l.splitDataNode(c,i);l.isCharacterDataNode(a)&&0<b&&b<a.length&&(a=l.splitDataNode(a,b),e?(i-=b,c=a):c==a.parentNode&&i>=l.getNodeIndex(a)&&i++,b=0);d(this,a,b,c,i)},normalizeBoundaries:function(){v(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,i=this.endOffset,e=function(a){var b=
a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,i=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},j=function(d){var e=d.previousSibling;if(e&&e.nodeType==d.nodeType){a=d;var j=d.length;b=e.length;d.insertData(0,e.data);e.parentNode.removeChild(e);a==c?(i+=b,c=a):c==d.parentNode&&(e=l.getNodeIndex(d),i==e?(c=d,i=j):i>e&&i--)}},k=!0;l.isCharacterDataNode(c)?c.length==i&&e(c):(0<i&&(k=c.childNodes[i-1])&&l.isCharacterDataNode(k)&&e(k),k=!this.collapsed);k?l.isCharacterDataNode(a)?0==b&&j(a):
b<a.childNodes.length&&(e=a.childNodes[b])&&l.isCharacterDataNode(e)&&j(e):(a=c,b=i);d(this,a,b,c,i)},collapseToPoint:function(a,b){o(this);x(a,!0);w(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&d(this,a,b,a,b)}});F(b)}function N(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:l.getCommonAncestor(a.startContainer,a.endContainer)}function J(a,b,c,i,e){var j=a.startContainer!==
b||a.startOffset!==c,k=a.endContainer!==i||a.endOffset!==e;a.startContainer=b;a.startOffset=c;a.endContainer=i;a.endOffset=e;N(a);d(a,"boundarychange",{startMoved:j,endMoved:k})}function C(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};N(this)}a.requireModules(["DomUtil"]);var l=a.dom,u=l.DomPosition,B=a.DOMException;q.prototype={_current:null,_next:null,_first:null,_last:null,isSingleCharacterDataNode:!1,reset:function(){this._current=
...
this.ec?this.eo:a.length,b!=c&&a.deleteData(b,c-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return c(this._current,this.range)},getSubtreeIterator:function(){var a;if(this.isSingleCharacterDataNode)a=this.range.cloneRange(),a.collapse();else{a=new C(b(this.range));var c=this._current,d=c,i=0,e=c,j=l.getNodeLength(c);l.isAncestorOf(c,this.sc,!0)&&(d=this.sc,i=this.so);l.isAncestorOf(c,this.ec,!0)&&(e=this.ec,j=this.eo);J(a,d,i,e,j)}return new q(a,this.clonePartiallySelectedTextNodes)},
...
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;e(b,b._ranges[b.rangeCount-1],!1)}}}function i(a,b){for(var c=a.docSelection.createRange(),d=g(b),i=m.getDocument(c.item(0)),i=m.getBody(i).createControlRange(),e=0,f=c.length;e<f;++e)i.add(c.item(e));try{i.add(d)}catch(j){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}i.select();k(a)}function n(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
...
return!0}};var P=function(a,b){var c=a.getAllRanges(),d=!1;a.removeAllRanges();for(var i=0,e=c.length;i<e;++i)d||b!==c[i]?a.addRange(c[i]):d=!0;a.rangeCount||f(a)};u.removeRange=l?function(a){if("Control"==this.docSelection.type){for(var b=this.docSelection.createRange(),a=g(a),c=m.getDocument(b.item(0)),c=m.getBody(c).createControlRange(),d,i=!1,e=0,f=b.length;e<f;++e)d=b.item(e),d!==a||i?c.add(b.item(e)):i=!0;c.select();k(this)}else P(this,a)}:function(a){P(this,a)};var H;!D&&E&&a.features.implementsDomRange?
...
(function(a){function c(a){return a.replace(e,function(a,b){var c=(b.match(f)||[])[1]||"",d=g[c],b=b.replace(f,"");b.split(d).length>b.split(c).length&&(b+=c,c="");var e=d=b;b.length>h&&(e=e.substr(0,h)+"...");"www."===d.substr(0,4)&&(d="http://"+d);return'<a href="'+d+'">'+e+"</a>"+c})}function b(f){if(!d.contains(f.nodeName))if(f.nodeType===a.TEXT_NODE&&f.data.match(e)){var k=f.parentNode,i;i=k.ownerDocument;var h=i._wysihtml5_tempElement;h||(h=i._wysihtml5_tempElement=i.createElement("div"));i=
h;i.innerHTML="<span></span>"+c(f.data);for(i.removeChild(i.firstChild);i.firstChild;)k.insertBefore(i.firstChild,f);k.removeChild(f)}else{k=a.lang.array(f.childNodes).get();i=k.length;for(h=0;h<i;h++)b(k[h]);return f}}var d=a.lang.array("CODE,PRE,A,SCRIPT,HEAD,TITLE,STYLE".split(",")),e=/((https?:\/\/|www\.)[^\s<]{3,})/gi,f=/([^\w\/\-](,?))$/i,h=100,g={")":"(","]":"[","}":"{"};a.dom.autoLink=function(a){var c;a:{c=a;for(var i;c.parentNode;){c=c.parentNode;i=c.nodeName;if(d.contains(i)){c=!0;break a}if("body"===
...
e,d)}}};
wysihtml5.dom.parse=function(){function a(c,e){var f=c.childNodes,k=f.length,j;j=b[c.nodeType];var h=0;j=j&&j(c);if(!j)return null;for(h=0;h<k;h++)(newChild=a(f[h],e))&&j.appendChild(newChild);return e&&1>=j.childNodes.length&&j.nodeName.toLowerCase()===d&&!j.attributes.length?j.firstChild:j}function c(a,b){var b=b.toLowerCase(),c;if(c="IMG"==a.nodeName)if(c="src"==b){var d;try{d=a.complete&&!a.mozMatchesSelector(":-moz-broken")}catch(e){a.complete&&"complete"===a.readyState&&(d=!0)}c=!0===d}return c?
...
j={url:function(){var a=/^https?:\/\//i;return function(b){return!b||!b.match(a)?null:b.replace(a,function(a){return a.toLowerCase()})}}(),alt:function(){var a=/[^ a-z0-9_\-]/gi;return function(b){return!b?"":b.replace(a,"")}}(),numbers:function(){var a=/\D/g;return function(b){return(b||"").replace(a,"")||null}}()},k={align_img:function(){var a={left:"wysiwyg-float-left",right:"wysiwyg-float-right"};return function(b){return a[(""+b).toLowerCase()]}}(),align_text:function(){var a={left:"wysiwyg-text-align-left",
